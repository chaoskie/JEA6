        ...
        case 'USER_FOLLOW_SUCCESS':
            {
                ...
                user = { ...user, following: user.following ? [...user.following, action.payload.userFollowed] : [action.payload.userFollowed] };
        ...
        case 'USER_UNFOLLOW_SUCCESS':
            {
                ...
                user = { ...user, following: user.following ? user.following.filter(u => u.id !== action.payload.userUnfollowed.id) : [] }
